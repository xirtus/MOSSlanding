...
class VoiceGenPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._gen_btn.setStyleSheet("font-size: 15px; font-weight: 600; border-radius: 12px;")
        self._gen_btn.clicked.connect(self._generate)
        right_layout.addWidget(self._gen_btn)
        ...
        if not self._backend.is_loaded:
            ...
            if reply == QMessageBox.Yes:
                try:
                    ...
                    self._backend.load_model(MODEL_VOICE_GEN)
                except Exception as e:
