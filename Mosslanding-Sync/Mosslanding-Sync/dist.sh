...
# Regenerate icon natively (CoreGraphics, no venv required)
swift "$SCRIPT_DIR/scripts/make_icon.swift" "$APP/Contents/Resources/AppIcon.iconset"
...
swift "$SCRIPT_DIR/scripts/make_dmg_bg.swift" "$BG_PATH"
